...
public class Goomba extends GameCharacter {
    ...
    protected void initBody() {
        ...
        shape.setRadius(8f / AntGame.W_SCALE);
        ...
        shape = new EdgeShape();
        ((EdgeShape) shape).set(new Vector2(-7f / AntGame.W_SCALE, 9f / AntGame.W_SCALE), new Vector2(7f / AntGame.W_SCALE, 9f / AntGame.W_SCALE));
    ...
    public void update(float dt) {
        if (isDestroying && !destroyed) {
            ...
            setRegion(re);
            setBounds(0, 0, re.getRegionWidth() / AntGame.W_SCALE, re.getRegionHeight() / AntGame.W_SCALE);
