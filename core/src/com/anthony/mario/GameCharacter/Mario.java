...
public class Mario extends GameCharacter {
  ...
  protected void initBody() {
    ...
    shape = new EdgeShape();
    ((EdgeShape) shape).set(new Vector2(-2f / AntGame.W_SCALE, 8f / AntGame.W_SCALE),
        new Vector2(2f / AntGame.W_SCALE, 8f / AntGame.W_SCALE));
    fixtureDef.shape = shape;
  ...
  public void update(float dt) {
    ...
    setRegion(re);
    setBounds(0, 0, (re.getRegionWidth() + 3f) / AntGame.W_SCALE,
